 ...
 * [DASHO.yml](DASHO.yml)
     * Determines how your purl.obolibrary.org/obo/DASHO/ redirects will be handled
     ...
     * Paste in the contents of [DASHO.yml](DASHO.yml)
 ...
 * [DASHO.md](DASHO.md)
     ...
     * Paste in the contents of [DASHO.md](DASHO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
